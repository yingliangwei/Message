...
import com.example.message.IMyAidlInterface;
import com.example.message.R;
import com.example.message.listener.ScreenListener;
import com.example.message.sms.SMSVerification;
import com.example.message.socket.SocketManage;
import com.example.message.socket.listener.OnConnection;
import com.example.message.util.AESUtil;
import com.example.message.util.AppIconUtil;
import com.example.message.util.Notification;
